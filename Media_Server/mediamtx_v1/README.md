...
2.  Go to the [Mediamtx releases page](https://github.com/bluenviron/mediamtx/releases) and copy the download link for the latest `mediamtx_v1.13.1_linux_arm64.tar.gz` file.

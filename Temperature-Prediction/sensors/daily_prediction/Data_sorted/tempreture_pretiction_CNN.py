...
# -----------------------------
model = Sequential([
    Conv1D(128, kernel_size=2, activation='tanh', strides=1, padding='same',input_shape=(x_train.shape[1], n_features)),
    Conv1D(64, kernel_size=2, strides=1, padding='same', activation='tanh'),
    Conv1D(32, kernel_size=2 , strides=1, padding='same', activation = 'tanh'),
    Flatten(),

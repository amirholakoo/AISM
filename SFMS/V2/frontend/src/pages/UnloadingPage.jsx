...
export default function UnloadingPage() {
  ...
  const { selectedShipment, selectedWarehouse, setSelectedShipment, setSelectedWarehouse, selectedCameraId } = useUnloadingContext();
  ...
  const handleEnd = async () => {
    ...
    try {
      ...
      const requestBody = { warehouse_id: warehouseId, operation_type: 'unloading', camera_id: selectedCameraId };

    ...
    def _initialize_video_source(self, source):
        ...
        if source.lower() == "picamera" and IS_PICAMERA_AVAILABLE:
            try:
                ...
                # Construct a path to the tuning file relative to this script's location
                # This makes the project portable and independent of the user's home directory.
                script_dir = os.path.dirname(__file__)
                project_root = os.path.abspath(os.path.join(script_dir, '..'))
                # Use the correct tuning file for the OV5647 sensor
                ...
                # Configure for lower latency and specified FPS, matching the new mediamtx.yml cam1

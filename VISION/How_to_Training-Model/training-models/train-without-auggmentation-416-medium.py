#!/usr/bin/env python3
"""
YOLOv11m Training Script - Optimized for Raspberry Pi 5 + NCNN Deployment
...
def train_and_export(dataset_path: str = "dataset", epochs: int = 100, size: str = "m"):
    print("\n" + "="*50)
    print("    YOLOv11m TRAINING FOR RASPBERRY PI 5 + NCNN")
    print("="*50)
    ...
    train_args = {
        "data": dataset_yaml,
        "epochs": epochs,
        "imgsz": 416,               # BEST speed/accuracy trade-off on Pi 5
        "batch": 4,                 # Safe & fast
        "device": 0 if gpu_available else "cpu",
        "workers": 4,
        "project": "yolov11m_pi5",
    ...
    # BEST MODEL PATH
    best_pt = Path("yolov11m_pi5/akhal_detection/weights/best.pt")
    last_pt = Path("yolov11m_pi5/akhal_detection/weights/last.pt")
    ...
    try:
        ...
        print(f"   yolo export model={best_pt} format=ncnn imgsz=320 half=True")
...
def main():
    ...
    model_size = "m"           # m = mediume (perfect for Pi 5)

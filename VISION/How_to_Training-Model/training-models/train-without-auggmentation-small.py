#!/usr/bin/env python3
"""
YOLOv11n Training Script - Optimized for Raspberry Pi 5 + NCNN Deployment
...
def train_and_export(dataset_path: str = "dataset", epochs: int = 100, size: str = "n"):
    print("\n" + "="*50)
    print("    YOLOv11n TRAINING FOR RASPBERRY PI 5 + NCNN")
    print("="*50)
    ...
    train_args = {
        "data": dataset_yaml,
        "epochs": epochs,
        "imgsz": 640,               # BEST speed/accuracy trade-off on Pi 5
        "batch": 32,                 # Safe & fast
    ...
    # BEST MODEL PATH
    best_pt = Path("yolov11_pi5/akhal_detection/weights/best.pt")
    last_pt = Path("yolov11_pi5/akhal_detection/weights/last.pt")
